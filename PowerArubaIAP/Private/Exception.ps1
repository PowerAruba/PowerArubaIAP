...
#
function Show-ArubaIAPException() {
    Param(
    ...
    if ($Exception.Exception.InnerException) {
        ...
        if ("AuthenticationException" -eq $exceptiontype.name) {
            ...
            Write-Warning "Try to use Connect-ArubaIAP -SkipCertificateCheck for connection"
    ...
    If ($Exception.Exception.Response) {
        ...
        Write-Warning "The ArubaIAP API sends an error message:"
